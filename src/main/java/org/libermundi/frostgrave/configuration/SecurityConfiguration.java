...
import org.libermundi.frostgrave.repositories.security.RememberMeTokenRepository;
import org.libermundi.frostgrave.repositories.security.impl.PersistentTokenRepositoryImpl;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    @Value("${frostgrave.security.rememberme.key}")
    ...
    public RoleHierarchy roleHierarchy() {
        ...
        roleHierarchy.setHierarchy("ROLE_SYSTEM > ROLE_ROOT \n ROLE_ROOT > ROLE_ADMIN \n ROLE_ADMIN > ROLE_USER \n ROLE_USER > ROLE_ANONYMOUS");
