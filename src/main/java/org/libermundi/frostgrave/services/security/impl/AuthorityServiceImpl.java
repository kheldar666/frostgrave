...
import org.libermundi.frostgrave.repositories.security.AuthorityRepository;
...
public class AuthorityServiceImpl extends AbstractServiceImpl<Authority> implements AuthorityService {
	...
	/* (non-Javadoc)
	 * @see org.libermundi.frostgrave.security.services.SecurityManager#hasReachableAuthority(java.util.Collection, org.springframework.security.core.GrantedAuthority)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.libermundi.frostgrave.security.services.SecurityManager#hasReachableAuthority(org.libermundi.frostgrave.security.model.User, org.springframework.security.core.GrantedAuthority)
	 */
	@Override
