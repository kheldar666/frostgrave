...
import org.libermundi.frostgrave.services.utils.StringFormatService;
...
public class StringFormatServiceImpl implements StringFormatService {
    ...
    public StringFormatServiceImpl(@Value("${frostgrave.general.dateformat}") String dateformat,
                                   @Value("${frostgrave.general.timeformat}") String timeformat,
